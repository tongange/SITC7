...
@Controller
@Scope("prototype")
@RequestMapping(value = "/stdSchoolLeaving")
@SuppressWarnings("all")
public class StdSchoolLeavingController extends JavaEE7BaseController
{
    private static final long serialVersionUID = 66838503104859456L;

    private final String basePath = "/stdSchoolLeaving/";
